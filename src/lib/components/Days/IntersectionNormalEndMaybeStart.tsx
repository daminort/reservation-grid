...
const IntersectionNormalEndMaybeStart = () => {
  const theme = useTheme();
  const colorPrimary = theme['color.awaiting'];
  const colorSecondary = theme['color.confirmed'];
  ...
  return (
    <svg
      ...
      data-testid="intersection.normal.end.maybe.start"
    >
      <path
