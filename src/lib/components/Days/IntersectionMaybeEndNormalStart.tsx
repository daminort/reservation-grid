...
const IntersectionMaybeEndNormalStart = () => {
  const theme = useTheme();
  const colorPrimary = theme['color.confirmed'];
  const colorSecondary = theme['color.awaiting'];
  ...
  return (
    <svg
      ...
      data-testid="intersection.maybe.end.normal.start"
    >
      <path
